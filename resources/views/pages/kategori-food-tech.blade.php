...
@section('tittle')
    Food Blog - Food Technology
@endsection

@section('content')
@php
$articlesWithSubCategoryThree = $articles->where('id_sub_categories', 3);
$videosWithSubCategoryThree = $videos->where('id_sub_categories', 3);
@endphp
<div class="container">
    <div class="mt-lg-3 mb-lg-3 mt-3 mb-3 title">
      <h2 class="text-lg-center text-center">Food Technology</h2>
      <h5 class="ms-2 text-lg-center text-center ms-lg-0 artikel">Video Food Technology</h5>
    </div>
      ...
      @if ($videosWithSubCategoryThree->isNotEmpty())
        ...
        @else
            <div class="col-lg-4 video-wt" style="cursor: default">
                <h5 style="margin-bottom: 118px">Belum Ada Video di Publish</h5>
            </div>
        @endif
      <!-- end video container -->
    </div>
    <!-- artikel -->
    <div>
      <h5 class="mt-lg-4 mb-lg-3 artikel">Artikel Food Technology</h5>
