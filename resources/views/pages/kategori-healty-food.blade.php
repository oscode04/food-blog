...
@section('tittle')
Food Blog - Healty Food
@endsection

@section('content')
@php
$articlesWithSubCategoryThree = $articles->where('id_sub_categories', 5);
$videosWithSubCategoryThree = $videos->where('id_sub_categories', 5);
@endphp
<div class="container">
  <div class="mt-lg-3 mb-lg-3 mt-3 mb-3 title">
    <h2 class="text-lg-center text-center">Healty Food</h2>
    <h5 class="ms-2 text-lg-center text-center ms-lg-0">Video Healty Food</h5>
  </div>
  ...
  <!-- artikel -->
  <div>
    <h5 class="mt-lg-4 mb-lg-3 artikel">Artikel Healty Food</h5>
