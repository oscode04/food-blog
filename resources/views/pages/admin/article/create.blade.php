...
<div
    ...
    <div class="container-fluid">
        <div class="dashboard-heading">
            <h2 class="dashboard-title">Buat Artikel Baru</h2>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{route('article.store')}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            <label class="fw-semibold">Upload Gambar Utama Artikel</label> <br>
                                            <input type="file" name="main_img" id="image" required>
                                        </div>
                                    </div>
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <div class="form-group">
                                            ...
                                            <textarea name="article_contens" id="editor"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
